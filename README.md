...
5. **Капча.** Якщо вона з'являється — пишемо в лог `! captcha block`, кидаємо алерт у Telegram. Не намагаємось обходити автоматично — це межа, за яку production не повинен переступати без письмового погодження бізнесу.
